...
const (
	...
	MsgTypeTypingStart    = 310 // User started typing
	MsgTypeTypingEnd      = 311 // User stopped typing
	MsgTypeRecordingStart = 312 // User started recording voice
	MsgTypeRecordingEnd   = 313 // User stopped recording voice
)
...
func (c *Client) handlePresenceMessage(msg ClientMessage) {
	...
	case MsgTypeTypingStart, MsgTypeTypingEnd, MsgTypeRecordingStart, MsgTypeRecordingEnd:
		// Broadcast typing/recording status to all other users in the chat room
		if msg.TargetID != "" {
			...
			c.hub.BroadcastToRoomExcept(msg.TargetID, data, c)
		}
	}
}
