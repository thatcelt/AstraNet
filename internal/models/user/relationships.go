...
type Comment struct {
	...
	Type           int              `gorm:"default:0" json:"type"`     // 0 = text, 1 = sticker, 2 = media
	StickerID      *string          `json:"stickerId,omitempty"`
	StickerIcon    *string          `json:"stickerIcon,omitempty"`
	StickerMedia   *string          `json:"stickerMediaValue,omitempty"`
	MediaList      *utils.MediaList `gorm:"type:text" json:"mediaList,omitempty"`
	...
	// Не хранится в БД - вычисляется при запросе
