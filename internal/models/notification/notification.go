...
const (
	...
	NotificationBlogLike      NotificationType = 5  // Someone liked your blog post
	NotificationCommentLike   NotificationType = 6  // Someone liked your comment
	NotificationReadModeOn    NotificationType = 10 // Read mode enabled (important)
	NotificationReadModeOff   NotificationType = 11 // Read mode disabled (important)
	NotificationRoleTransfer  NotificationType = 12 // Admin role transfer (important)
	NotificationChatAssign    NotificationType = 13 // Assigned to a chat (important)
)
...
const (
	...
	ObjectTypeComment ObjectType = 3 // Comment
)
...
type Notification struct {
	...
	IsImportant    bool             `json:"isImportant" gorm:"default:false;index"`
	IsAcknowledged bool             `json:"isAcknowledged" gorm:"default:false"`
